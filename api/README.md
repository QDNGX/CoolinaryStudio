...
| Артефакт | Что взято |
|---|---|
| [er-model-cooking.md](../analytics/design/er-model-cooking.md) | Сущности, поля, enum'ы, матрица доступа «кто читает / кто меняет» → схемы и security по ролям |
| [sequence-create-booking-cooking.md](../analytics/design/sequence-create-booking-cooking.md) | Контракт `POST /bookings`: ветки 201/409/410, предусловия 401/403 |
| [functional-requirements-cooking.md](../analytics/requirements/functional-requirements-cooking.md) | ФТ-01…ФТ-25 → операции |
| [use-cases-cooking.md](../analytics/requirements/use-cases-cooking.md) | Основные/альтернативные потоки → коды ответов |
| [non-functional-requirements-cooking.md](../analytics/requirements/non-functional-requirements-cooking.md) | НФТ-04 (лимиты кода входа → 429/400), НФТ-02/03/07 |
| [design-decisions-cooking.md](../analytics/design-brief/design-decisions-cooking.md) | Р-01…Р-16: гостевой доступ, лимиты текстов, видимость комментариев и др. |
| [screen-registry-cooking.md](../analytics/design-brief/screen-registry-cooking.md) | Проверка полноты: каждый экран SCR-01…SCR-17 обслужен эндпоинтами |
